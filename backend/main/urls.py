...
from .views import profile, index, settings, test_result, contacts, subscribtions, ab_initio, news, about_us, games, vlek, memory_test, multitasking_test, basic_coordination_test
